...
namespace iText.PdfCleanup.Logs {
    public class CleanUpLogMessageConstant {
        ...
        public const String IMAGE_MASK_CLEAN_UP_NOT_SUPPORTED = "Partial clean up of transparent images with mask encoded with one of the following filters is not "
